...
const Gallery = () => {
    ...
    return (
        <div className='max-w-[1000px] mx-auto pt-5 pb-24'>
            <p className='text-[12px] pb-5 text-end'> <Link to="/" className='text-[#FF9600] hover:underline cursor-pointer'>WORLD NAVI TOP</Link> {">"} Gallery</p>
                    ...
                    <div className="grid grid-cols-4 gap-4">
                        {[galleryImg1, galleryImg2, galleryImg3, galleryImg4, galleryImg5, galleryImg6, galleryImg7, galleryImg8, galleryImg9].map((img, index) => (
                            <img
                                ...
                                src={img}
                                alt={`Gallery ${index + 1}`}
                                className="w-[150px] h-[150px] object-cover rounded-md border border-gray-200"
                            />
                        ))}
                    </div>
