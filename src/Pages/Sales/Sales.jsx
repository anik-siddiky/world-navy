...
const Sales = () => {
    const salesCardData = [
        {
            image: salesImg1,
            title: 'Receiving orders from customers',
            description:
        ...
        {
            image: salesImg2,
            title: 'Searching the Right Vehicles',
            description:
    ...
    return (
        <div className="max-w-[1000px] mx-auto pt-5 pb-10 px-3 lg:px-0">
            ...
            <div className="flex flex-col lg:flex-row gap-6 lg:gap-10">
                <img
                    className="w-full lg:w-auto h-auto lg:h-[270px] object-cover"
                    src={banner}
                    alt="" />
                ...
                <div className="space-y-8 lg:space-y-10">
                    ...
                    <img className="w-full lg:w-auto" src={salesImg} alt="" />

                    <img className="w-full lg:w-auto" src={shipAndCarImg} alt="" />

                    <img className="w-full lg:w-auto" src={trustToSpeed} alt="" />

                    <p className="text-[13px] leading-[1.9] text-center px-2 lg:px-0">
                        World Navi Co.,Ltd pursues both speed and quality. <br />
                        Our business policy is to make every single transaction of the car a
                        satisfactory experience for both the seller and the buyer.
                    </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8">
                        {salesCardData.map((item, index) => (
                            <div
                                ...
                                <div className="p-3 border-3 border-t-0 border-[#FE9900] h-52 flex flex-col">
                                    <h3 className="text-lg text-[#FE9900] font-medium">
                                        {item.title}
                                    </h3>
                                    <p className="text-[13px] leading-[1.8] text-gray-700 mt-2 overflow-hidden">
                                        {item.description}
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="flex gap-4 lg:gap-9 justify-center">
                        <Link to="/business-description">
                            <img className="w-full sm:w-auto" src={btn1} alt="" />
                        </Link>
                        <Link to="/sales">
                            <img className="w-full sm:w-auto" src={btn2} alt="" />
                        </Link>
                        <Link to="/acquisition">
                            <img className="w-full sm:w-auto" src={btn3} alt="" />
                        </Link>
                    </div>
                </div>
            </div>
