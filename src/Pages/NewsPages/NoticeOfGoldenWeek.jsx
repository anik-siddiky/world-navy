  ...
  return (
    <div className="max-w-[1000px] mx-auto mb-10 px-3 lg:px-0">
      ...
      <p className="text-[12px] py-5 text-end">
        ...
        {">"} news {">"} Notice of office closure during Golden Week
      </p>

      {/* Responsive wrapper: stack on mobile/tablet */}
        ...
        <div className="space-y-8 lg:space-y-10">
          ...
          <div>
            <h3 className="text-xl font-normal mb-2">
              Notice of office closure during Golden Week
            </h3>
          ...
          <div>
            <p className="text-[13px] leading-[1.9] px-2 lg:px-0">
              ...
              <br />
              <br />
              To whom it may concern, please be informed of our office closure for the 2025 summer holiday.
